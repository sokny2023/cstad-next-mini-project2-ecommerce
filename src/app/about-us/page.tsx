...
const Page = () => {
 return (
    <section className="bg-gray-100">
      <div className="container mx-auto w-[94%] py-16 px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-8">
          <div className="max-w-lg">
            ...
            <div className="mt-8">
              <a href="#" className="text-[20px] text-emerald-500 hover:text-emerald-600 font-medium">Learn more about us
